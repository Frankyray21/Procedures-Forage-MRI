...
window.QUIZ_PROC = {
  ...
  "pro-mec-011": [
    ...
    { "q": "Pourquoi faut-il remettre le couvercle de plastique à la fin ?",
      "o": ["Pour l'esthétique", "Pour rétablir la protection", "Pour le poids", "Ce n'est pas requis"], "a": 1,
    ...
    { "q": "Quel danger est associé à la surchauffe du bell housing et du couvercle ?",
      "o": ["Choc électrique", "Un début d'incendie", "Une explosion", "Le gel"], "a": 1,
      "e": "« ...mesure issue d'un début d'incendie causé par surchauffe du bell housing et du couvercle. »" },
  ...
  "pro-op-ith-002": [
    ...
    { "q": "Avant de donner un coup de masse sur le manche de la clé, que faut-il vérifier ?",
      ...
      "e": "« Lors d'un coup de masse sur le manche de la clé, s'assurer d'avoir les pieds sur une surface solide. »" },
    { "q": "Lors d'un coup de masse, où personne ne doit-il se trouver ?",
      ...
      "e": "« S'assurer que personne ne se trouve dans la ligne de la masse advenant qu'elle soit échappée. »" },
    ...
    { "q": "Quand peut-on retirer les clés et décadenasser ?",
      ...
      "e": "« Retirer les clés et décadenasser l'équipement uniquement une fois l'opération terminée. »" }
  ],
  "pro-op-ith-002a": [
  ...
  "pro-op-ith-003": [
    { "q": "Que faut-il faire des accessoires de levage avant le déplacement ?",
      ...
      "e": "« Les accessoires de levage doivent être inspectés avant leur utilisation. Si une anomalie est détectée, le remplacement de l'accessoire est obligatoire avant d'entreprendre le déplacement. »" },
    ...
    { "q": "Que faut-il faire avant de manipuler le câble électrique ?",
      "o": ["Le couper", "Fermer le disjoncteur (alimentation ON juste avant de déplacer)", "Le mouiller", "Rien"], "a": 1,
      "e": "« Fermer le disjoncteur du panneau électrique de la foreuse avant de manipuler le câble, et ne remettre l'alimentation à ON que juste avant de déplacer l'équipement. »" },
    { "q": "Que faut-il purger avant de découpler les boyaux ?",
      ...
      "e": "« Il est très important de purger les boyaux à air [...] et le boyau à eau avant de les découpler. »" },
    ...
    { "q": "Que doit-on vérifier sur la foreuse avant le transport ?",
      ...
      "e": "« S'assurer qu'aucune pièce libre ni outil ne se trouve sur la foreuse avant de commencer le transport. »" },
    ...
    { "q": "Que faut-il maintenir avec l'opérateur de la chargeuse durant le déplacement sans remorque ?",
      ...
      "e": "« Maintenir une bonne communication avec l'opérateur de la chargeuse durant le déplacement sans remorque. »" }
  ],
  "pro-op-ith-004": [
    { "q": "Dans quelle position doivent être les leviers avant de mettre l'unité sous tension ?",
      ...
      "e": "« Vérifier tous les leviers de commande et les mettre au neutre (point mort) avant de mettre l'unité de forage sous tension. »" },
    ...
    { "q": "Avant de manipuler les tiges, dans quel état doit être la foreuse ?",
      ...
      "e": "« Avant de manipuler les tiges de forage, relever et arrêter la boîte de vitesse et mettre la foreuse à la position neutre (point mort). »" },
  ...
  "pro-op-ith-005": [
    { "q": "L'installation du couvert sur la monterie est-elle obligatoire ?",
      ...
      "e": "« L'installation du couvert fourni par M.R.I. ou le client sur la monterie est obligatoire en tout temps lors du forage de V-30 en descendant. »" },
    ...
    { "q": "Que faut-il éviter par rapport à la tête V-30 si elle se décroche ?",
      ...
      "e": "« Ne jamais se tenir dans l'axe de déplacement possible de la tête si elle se décroche. S'assurer que les contrôles soient en position neutre. »" },
    { "q": "Pendant le forage, qui peut circuler en avant de la foreuse ?",
      "o": ["L'aide-foreur", "Personne", "Le superviseur", "L'électricien"], "a": 1,
      "e": "« Aucune circulation permise en avant de la foreuse pendant le forage. »" },
    ...
    { "q": "Peut-on interchanger les boyaux basse et haute pression ?",
      ...
      "e": "« Les stem nuts empêchent l'interchange entre basse et haute pression. »" },
    ...
    { "q": "Après un bris de tige, comment protège-t-on l'accès au chantier ?",
      ...
      "e": "« Installer une barricade, un ruban rouge et/ou des panneaux ACCÈS INTERDIT à l'entrée du chantier pour empêcher tout accès. »" },
    ...
    { "q": "Quel EPI antichute porte-t-on si le couvert est enlevé et qu'on s'expose à une chute ?",
      ...
      "e": "« ...il doit porter le harnais de sécurité antichute et être attaché à des points d'ancrage approuvés par le client. »" },
  ...
  "pro-op-ith-006": [
    { "q": "Avant de mettre l'unité sous tension, les leviers sont mis...",
      ...
      "e": "« Vérifier que tous les leviers de commande sont au neutre (point mort) avant de mettre l'unité sous tension. »" },
    ...
    { "q": "Pourquoi ne peut-on pas interchanger les boyaux basse et haute pression ?",
      ...
      "e": "« Les stem nuts sur les boyaux de 2½ po. dia. sont faits pour qu'ils ne puissent pas être interchangés entre la basse et haute pression. »" },
    ...
    { "q": "Quand doit-on porter tout l'EPI requis ?",
      ...
      "e": "« Porter tout l'équipement de protection individuel (EPI) requis lors de l'affûtage et du façonnement des forets. »" },
    { "q": "Pendant le forage, peut-on circuler en avant de la foreuse ?",
      ...
      "e": "« Pendant le forage, interdire à toute personne de circuler en avant de la foreuse. »" },
    { "q": "Avant de manipuler les tiges, dans quel état est la foreuse ?",
      ...
      "e": "« Pour installer ou enlever les tiges, relever et arrêter la boîte de vitesse et placer la foreuse au point mort. »" },
    ...
    { "q": "En cas de bris de tige, qui doit-on aviser avant de reprendre le forage ?",
      ...
      "e": "« Aviser le contremaître; aucun travail de forage n'est permis avant son arrivée et sa présence est requise jusqu'à la fin de la récupération de la tige. »" }
  ],
  "pro-op-ith-007": [
    ...
    { "q": "Lors de l'entretien ou d'un bris de tige, où doit être le travailleur (ou la manette) ?",
      ...
      "e": "« ...le travailleur (ou la manette de contrôle à distance) doit être à 5 mètres de la ligne de forage et hors de la ligne de tir de chutes de la monterie. »" },
    ...
    { "q": "À quoi sert la cage de protection à grillage à mailles soudées ?",
      ...
      "e": "« Installer la cage de protection à grillage à mailles soudées pour canaliser les débris loin de l'opérateur. »" },
    ...
    { "q": "Peut-on se tenir dans l'axe de déplacement de la tête V-30 ?",
      ...
      "e": "« Ne jamais se tenir dans l'axe de déplacement possible de la tête si elle se décroche. »" },
    ...
    { "q": "Dans quel état doivent rester les accès entre les contrôles, le mât et le support à tige ?",
      ...
      "e": "« Garder libres en tout temps les accès séparant les contrôles, le mât et le support à tige (pas de boyaux, casing ni roche). »" },
    ...
    { "q": "Comment transporte-t-on le marteau ?",
      ...
      "e": "« Transporter le marteau à l'aide du chariot de transport stable; demander l'aide [...] d'un aide-foreur pour les trous de 200 pieds et plus. »" },
    { "q": "Que faut-il faire avant d'opérer la foreuse à distance pour récupérer une tige brisée ?",
      ...
      "e": "« Une analyse de risque doit être effectuée à ce point » (avant d'opérer la foreuse à distance pour récupérer une tige brisée)." },
    { "q": "Que coupe-t-on immédiatement lors d'un bris de tige ?",
      ...
      "e": "« Lors d'un bris de tige, fermer immédiatement l'interrupteur électrique et l'alimentation en air comprimé avant toute intervention. »" }
  ],
  "pro-op-ith-008": [
    ...
    { "q": "Pourquoi le harnais est-il obligatoire avant d'enlever le couvercle ?",
      "o": ["À cause du bruit", "À cause du risque de chute dans la monterie", "À cause de la poussière", "Aucune raison"], "a": 1,
      "e": "« Le port du harnais et l'attache à un ancrage ou à une ligne de vie sont obligatoires avant d'enlever le couvercle (risque de chute dans la monterie). »" },
  ...
  "pro-op-ith-012": [
    ...
    { "q": "Où le foreur et l'aide-foreur ne doivent-ils JAMAIS se tenir ?",
      ...
      "e": "« Ne jamais se tenir dans la ligne de sautage. »" },
    { "q": "Vers où doivent se positionner le foreur et l'aide-foreur ?",
      ...
      "e": "« Le foreur et l'aide-foreur doivent se positionner vers la sortie en s'assurant que rien ne bloque l'accès. »" },
    { "q": "Comment protège-t-on les accès aux lieux de forage ?",
      ...
      "e": "« Barricader tous les accès aux lieux de forage [...] Apposer une signalisation indiquant le type de travaux (ACCÈS INTERDIT, FORAGE EN COURS, FORAGE À DISTANCE). »" },
    ...
    { "q": "Comment doit-on procéder pour toute visite des lieux de forage ?",
      ...
      "e": "« Pour toute visite des lieux de forage, contacter l'opérateur par radio. »" },
  ...
  "pro-op-ith-014": [
    ...
    { "q": "Pourquoi ne pas laisser les tubages dépasser trop longs du plancher ?",
      ...
      "e": "« Les tubages peuvent devenir des embûches pour les travailleurs s'ils sont laissés trop longs [...]. Il faut que le trajet effectué par les travailleurs soit exempt de ces tubages qui dépassent. »" },
  ...
  "pro-op-ith-016": [
    { "q": "Comment transporte-t-on en tout temps les marteaux de 6\" ?",
      ...
      "e": "« Les marteaux de 6'' doivent toujours être transportés à l'aide du chariot conçu à cet effet. »" },
    ...
    { "q": "Que faut-il valider chaque fois qu'on doit exposer les mains sous le marteau ?",
      ...
      "e": "« À chaque fois qu'on doit s'exposer les mains sous le marteau, il faut valider que le marteau est bien vissé au Gear Box. »" },

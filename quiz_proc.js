...
window.QUIZ_PROC = {
  "centralisateur": [
    ...
    { "q": "Quel outil ne faut-il PAS utiliser pour serrer les boulons ?",
      "o": ["Une clé ¾", "Un box ¾", "Un wescot ou un pipe wrench"], "a": 2,
      "e": "« L'utilisation d'un wescot ou d'un pipe wrench n'est pas adéquate. » — on serre avec l'outil adéquat : une clé ou un box ¾." },
  ...
  "pro-mec-011": [
    ...
    { "q": "Avec quoi frappes-tu le bell housing pour le décoller ?",
      ...
      "img": "images/figures/pro-mec-011-6.jpg", "detail": "Le bell housing en aluminium." },
  ...
  "pro-op-ith-004": [
    ...
    { "q": "Quelle distance minimale laisses-tu entre la barricade et le premier matériel ?",
      ...
      "img": "images/figures/pro-op-ith-004-3.jpg", "detail": "Disposition du chantier de forage." },
  ...
  "pro-op-ith-005": [
    ...
    { "q": "Le couvert est enlevé. Comment doivent être les travailleurs près du trou ?",
      ...
      "img": "images/figures/pro-op-ith-005-6.jpg", "detail": "Le couvert de la monterie retiré, trou ouvert." },
  ...
  "pro-op-ith-006": [
    ...
    { "q": "Quelle distance minimale il faut entre la barricade et le premier matériel ?",
      "o": ["1 mètre", "3 mètres (10 pieds)", "7 mètres", "15 mètres"], "a": 1,
      "e": "« Laisser une distance d'au moins 3 mètres (10 pieds) entre la barricade à l'entrée du chantier et les premières pièces de matériel. »",
      "img": "images/figures/pro-op-ith-006-4.jpg", "detail": "Disposition du chantier de forage." },
  ...
  "pro-op-ith-007": [
    ...
    { "t": "vf", "q": "Il faut maintenir une distance de 7 mètres entre la foreuse et le compresseur.", "vrai": true,
      ...
      "img": "images/figures/pro-op-ith-007-2.jpg", "detail": "Disposition du chantier (foreuse, compresseur)." },

/* ===========================================================================
   QUIZ DE SÉCURITÉ — généré à partir des consignes des procédures.
   (Ce n'est pas une formation : auto-vérification rapide des réflexes.)
   =========================================================================== */
window.QUIZ = [
  {
    "id": "q1",
  ...
  },
  {
    ...
    "answer": 1,
    "explication": "La procédure précise que l'ancrage du mât est certifié 2500 kg et qu'il ne faut pas dépasser cette charge lors de la mise en tension avec le tire-fort.",
  ...
  },
  {
    ...
    "answer": 0,
    "explication": "La procédure exige que l'opérateur se place toujours à l'intérieur du panier de la foreuse et mette la chaîne garde-corps lors de l'embarquement.",
    "sourceId": "pro-op-ith-003",
    "code": "PRO-OP-ITH-003",
    "titre": "Démobilisation et déplacement de la foreuse et du compresseur",
    "categorie": "Démobilisation",
  ...
  },
  {
    ...
    "answer": 2,
    "explication": "La procédure exige obligatoirement une distance minimale de 1,5 mètre entre le mât et la console; quand une pièce est en mouvement, aucun travailleur ne doit se placer entre la console et le mât, ni à moins de 1,5 m du mât, de tous les côtés.",
    "sourceId": "pro-op-ith-004",
    "code": "PRO-OP-ITH-004",
  ...
  },
  {
    ...
    "answer": 2,
    "explication": "L'encadré INSPECTIONS précise qu'une attention particulière doit être portée aux boyaux tressés haute température (800 °F) des compresseurs; pour des raisons de sécurité, seul le type de boyau prescrit doit être utilisé.",
    "sourceId": "pro-op-ith-004",
    "code": "PRO-OP-ITH-004",
    "titre": "Procédure de forage de production, 3 7/8\" à 6 ½\"",
    "categorie": "Forage",
  ...
  },
  {
    ...
    "answer": 2,
    "explication": "La procédure prescrit de respecter une distance de 7 mètres entre la foreuse et le surcompresseur.",
    "sourceId": "pro-op-ith-004",
    "code": "PRO-OP-ITH-004",
    "titre": "Procédure de forage de production, 3 7/8\" à 6 ½\"",
    "categorie": "Forage",
  ...
  },
  {
    ...
    "answer": 2,
    "explication": "La procédure interdit à toute personne de circuler à moins de 5 mètres du mât de la foreuse pendant le forage (zone d'exclusion); la commande de forage est aussi placée à 5 m du point de forage.",
  ...
  },
  {
    ...
    "answer": 0,
    "explication": "La procédure exige de récupérer le taillant ou les pièces brisées au fond de la monterie uniquement à l'aide du racloir de monterie (raise scraper) conçu à cet effet.",
  ...
  },
  {
    ...
    "answer": 0,
    "explication": "La procédure exige d'installer le système de commande à distance à un minimum de 50' (15 mètres) entre le foreur et le trou à forer.",
  ...
  },
  {
    ...
    "options": [
      ...
      "3 pieds dans le roc solide",
      "1 pouce dans le roc solide"
    ],
    "answer": 0,

...
(function () {
  var DD = {
    ...
    "pro-dd-st-007": [
      ...
      { "t": "trou", "q": "Pour faire le ciment, on utilise le ciment de type ______.",
    ...
    "pro-dd-st-008": [
      ...
      { "t": "vf", "q": "Le support de tiges doit être penché de façon à avoir un angle entre 75° et 80°.",
        "vrai": true,
    ...
    "pro-dd-st-009-1": [
      ...
      { "t": "trou", "q": "Sur la STM-1500 avec lift kit, il faut ______.",
    ...
    "pro-dd-st-009-2": [
      { "t": "trou", "q": "Sur la foreuse DR-600 #2923, le pendage minimum qui nécessite une analyse est de ______.",
    ...
    "pro-op-dd-013": [
      ...
      { "t": "trou", "q": "Il faut toujours s'assurer d'avoir au moins ______ tiges sous la foreuse si on en utilise pour la rouler.",
    ...
    "ss-dd-st-001": [
      { "t": "trou", "q": "Le dead man doit être positionné à un minimum de ______ de la tour de la foreuse.",

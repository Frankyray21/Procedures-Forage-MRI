  ...
  var Q = {
    ...
    "pro-pt-001": [
      ...
      { "q": "Pendant le forage, à quelle distance du mât place-t-on les contrôles ?",
        ...
        "detail": "La station de contrôle (commande) du PIPE-TUB.",
    ...
    "pro-mec-004": [
      ...
      { "t": "erreur", "q": "Un collègue installe la nouvelle swivel. Quelle action est une ERREUR ?",
        "o": ["Il vérifie que le « O » ring est présent et en bon état.", "Il visse la swivel à la main le plus possible avant de finir le serrage.", "Il tient la swivel pour la guider pendant qu'il finit le serrage avec la rotation.", "Il remet les boyaux avec les câbles anti-fouets et le support."], "a": 2,
        "e": "« NE JAMAIS TENIR LA SWIVEL AVEC LES MAINS QUAND LA ROTATION EST ACTIONNÉE. » — la guider à la main pendant le serrage à la rotation est donc une erreur. Les autres actions sont conformes aux points 9, 10 et 13 du PDF." },
    ...
    "pro-mec-006": [
      ...
      { "q": "En changeant le saver sub avec le mât à la verticale, tu repositionnes la clé du saver sub sur les centralisateurs « jaw ». Pour ne pas te blesser, que faut-il éviter ?",
        ...
        "detail": "Sur la photo, le cercle jaune entoure l'endroit à ne jamais approcher avec les mains : manipule la clé par son extrémité, jamais entre la clé et le gear box.",
    ...
    "pro-mec-007": [
      ...
      { "q": "Sur quelle structure ne peux-tu PAS appuyer le blocage de bois ?",
        ...
        "detail": "Le blocage de bois et ses points d'appui sur la foreuse.",

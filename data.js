...
window.CODE_SECURITE = {
  "preambule": "Le présent Code de sécurité du forage — M.R.I. regroupe et harmonise en un document de référence unique l'ensemble des consignes de sécurité extraites des procédures de forage de Machines Roger International (foreuses ITH, CUBEX, têtes aléseuses V-30, centralisateurs, compresseurs et surcompresseurs, ainsi que les foreuses au diamant — carottage — STM-1500 et DR-600). Il a pour objet de protéger la santé et l'intégrité physique des travailleurs affectés au forage souterrain et de production. Les règles qui y figurent ont un caractère obligatoire : tout travailleur, foreur, aide-foreur ou superviseur intervenant sur l'équipement de forage doit les connaître et les appliquer en tout temps. Ce code ne remplace pas les procédures détaillées de chaque opération ni la réglementation applicable (notamment le Règlement sur la santé et la sécurité du travail dans les mines), mais en consolide les exigences essentielles. En cas de contradiction avec une exigence plus sévère du client, du site ou de la loi, c'est l'exigence la plus contraignante qui prévaut.",
  "chapitres": [
    {
      "id": "energie-cadenassage",
      "titre": "Chapitre 1 — Maîtrise des énergies, cadenassage et arrêt d'urgence",
      "intro": "Avant et pendant toute intervention, les énergies électrique (600 V), hydraulique et pneumatique doivent être maîtrisées. Le cadenassage, l'arrêt d'urgence (E-STOP) et la mise au neutre des commandes sont des conditions préalables obligatoires à de nombreuses opérations.",
      "articles": [
        {
          "num": "1.1",
          "titre": "Cadenassage avant intervention",
          "texte": "Le travailleur doit appliquer la procédure de cadenassage et d'étiquetage (lock out / tag out) avant d'entreprendre tout travail de maintenance, de changement de coupling, de dévissage de tiges ou de manipulation d'un marteau coincé. Les cadenas ne sont retirés et l'équipement n'est décadenassé qu'une fois l'opération terminée, et avant de poursuivre les travaux.",
          "sources": [
            "PRO-MEC-011",
            "PRO-OP-ITH-002",
            "PRO-OP-ITH-002A"
        ...
        {
          "num": "1.2",
          "titre": "Mise au neutre des commandes avant mise sous tension",
          "texte": "Le travailleur doit vérifier tous les leviers de commande et les placer au neutre (point mort) avant de mettre l'unité de forage sous tension.",
          "sources": [
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006",
        ...
        {
          "num": "1.3",
          "titre": "Position neutre avant de manipuler les tiges",
          "texte": "Avant de manipuler les tiges de forage, le travailleur doit relever et arrêter la boîte de vitesse (gear box) et mettre la foreuse à la position neutre (point mort / homme mort).",
          "sources": [
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006",
        ...
        {
          "num": "1.4",
          "titre": "Mise hors tension au point de forage (E-STOP)",
          "texte": "Au point de forage, le travailleur doit mettre la foreuse hors tension au moyen du E-STOP avant d'accrocher le câble électrique.",
          "sources": [
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006",
        ...
        {
          "num": "1.5",
          "titre": "Raccordement et rotation du moteur",
          "texte": "Le travailleur doit décharger, inspecter et brancher le câble électrique à la boîte de distribution d'énergie (ground fault box). Le rebranchement de la rotation du moteur électrique doit être confié à un électricien de la compagnie.",
          "sources": [
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006",
        ...
        {
          "num": "1.6",
          "titre": "Manipulation du câble sous tension",
          "texte": "Le travailleur ne doit manipuler une extension de câble électrique sous tension qu'à l'aide du crochet de plastique prévu à cet effet.",
          "sources": [
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006",
        ...
        {
          "num": "1.7",
          "titre": "Accrochage du câble électrique au mur",
          "texte": "Le travailleur doit accrocher le câble électrique au mur au niveau de la poitrine, soit à 4 à 5 pieds du banc (ou du plancher), pour éviter tout contact avec des roches branlantes ou des véhicules motorisés.",
          "sources": [
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006",
        ...
        {
          "num": "1.8",
          "titre": "Coupure des énergies en cas de bris de tige",
          "texte": "En cas de bris de tige, le travailleur doit arrêter immédiatement le forage et fermer l'interrupteur électrique ainsi que l'alimentation en air comprimé avant toute intervention.",
          "sources": [
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006",
            "PRO-OP-ITH-007"
        ...
        {
          "num": "1.9",
          "titre": "Commande à distance lors de la récupération d'une tige brisée",
          "texte": "Pour toute opération durant la récupération d'une tige brisée, le travailleur doit utiliser les contrôles à distance placés dans un endroit sécuritaire, éloigné de la foreuse.",
          "sources": [
            "PRO-OP-ITH-005"
          ]
        },
        {
          "num": "1.10",
          "titre": "Sécurisation des énergies avant nettoyage et tubage",
          "texte": "Avant de procéder au nettoyage lors de l'installation d'un tubage, le travailleur doit monter le marteau au-delà des tables, fermer la slip-plate ou les jaws, appuyer la bit sur la slip-plate ou les jaws, puis fermer l'interrupteur de la foreuse.",
          "sources": [
            "PRO-OP-ITH-014"
          ]
        },
        {
          "num": "1.11",
          "titre": "Gestion de l'alimentation lors de la démobilisation",
          "texte": "Lors de la démobilisation, le travailleur doit fermer le disjoncteur du panneau électrique de la foreuse avant de manipuler le câble et ne remettre l'alimentation à « ON » que juste avant le déplacement. Avant de débrancher le câble, il ferme l'interrupteur d'alimentation de la mine (GFP), puis roule et attache solidement le câble sur le crochet prévu.",
          "sources": [
            "PRO-OP-ITH-003"
          ]
        }
    ...
    {
      "id": "air-comprime-boyaux",
      "titre": "Chapitre 2 — Air comprimé et boyaux sous pression",
      "intro": "L'air comprimé et les lignes haute température représentent un danger majeur de fouettement et de brûlure. Les dispositifs de retenue, l'inspection des raccords et le respect des types de boyaux prescrits sont obligatoires.",
      "articles": [
        {
          "num": "2.1",
          "titre": "Boyaux tressés haute température (800 °F)",
          "texte": "Sur les CUBEX et les surcompresseurs, le travailleur doit porter une attention particulière aux boyaux tressés haute température (800 °F) des compresseurs et n'utiliser que le type de boyau prescrit. Aucun autre type de boyau n'est autorisé.",
          "sources": [
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006",
        ...
        {
          "num": "2.2",
          "titre": "Dispositifs de retenue (whip check)",
          "texte": "Le travailleur doit installer un dispositif de retenue (whip check) à chaque joint des boyaux d'air et à chaque connexion du boyau haute pression. Il doit vérifier l'état du câble métallique et le bon fonctionnement des mécanismes de serrage.",
          "sources": [
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006",
        ...
        {
          "num": "2.3",
          "titre": "Soufflage des boyaux avant connexion",
          "texte": "Le travailleur doit souffler les boyaux à air avant de les connecter.",
          "sources": [
            "PRO-OP-ITH-004"
          ]
        },
        {
          "num": "2.4",
          "titre": "Interdiction d'interchanger basse et haute pression",
          "texte": "Il est interdit d'interchanger les boyaux basse pression et haute pression. Les « stem nuts » des boyaux de 2½ po de diamètre sont conçus pour empêcher cet échange et éliminer tout accident potentiel.",
          "sources": [
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006",
            "PRO-OP-ITH-007"
        ...
        {
          "num": "2.5",
          "titre": "Inspection minutieuse des raccords et boyaux",
          "texte": "Le travailleur doit inspecter minutieusement les raccords et les boyaux : les collets doivent être bien serrés, les filets des raccords d'accouplement en bon état et les boyaux exempts de toute anomalie.",
          "sources": [
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006",
        ...
        {
          "num": "2.6",
          "titre": "Suspension des boyaux sous le câble électrique",
          "texte": "Le travailleur doit suspendre tous les boyaux sous le câble électrique afin d'éliminer tout contact avec des roches branlantes ou de l'équipement minier. À défaut, il doit étendre les boyaux, les surélever du banc à l'aide de bidons ou de trépieds en bois, et les rendre visibles (peinture ou banderole) pour éviter contact et écrasement.",
          "sources": [
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006"
        ...
        {
          "num": "2.7",
          "titre": "Pressurisation et détection des fuites",
          "texte": "Le travailleur doit pressuriser avec soin les lignes d'eau et d'air et les inspecter pour déceler toute fuite.",
          "sources": [
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006",
        ...
        {
          "num": "2.8",
          "titre": "Purge avant découplage lors de la démobilisation",
          "texte": "Avant de découpler les conduites, le travailleur doit fermer les valves à air et à eau et purger les boyaux à air, le filtre à air, le receiver et le boyau à eau.",
          "sources": [
            "PRO-OP-ITH-003"
          ]
        }
    ...
    {
      "id": "zones-exclusion-positionnement",
      "titre": "Chapitre 3 — Zones d'exclusion et positionnement des personnes et des équipements",
      "intro": "Le respect des distances de sécurité protège les travailleurs des pièces en mouvement, des projections de roches et des chutes d'objets. Ces distances sont impératives et non négociables.",
      "articles": [
        {
          "num": "3.1",
          "titre": "Distance minimale mât / console",
          "texte": "Le travailleur doit respecter obligatoirement une distance minimale de 1,5 mètre entre le mât et la console. La console doit être positionnée de manière à protéger les employés des pièces en mouvement et des projections de roches.",
          "sources": [
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-014"
        ...
        {
          "num": "3.2",
          "titre": "Zone d'exclusion autour du mât en mouvement",
          "texte": "Lorsqu'une pièce est en mouvement, aucun travailleur ne doit se placer entre la console et le mât, ni à moins de 1,5 mètre du mât de tous les côtés.",
          "sources": [
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-014"
          ]
        ...
        {
          "num": "3.3",
          "titre": "Zone d'exclusion de 5 mètres (alésage ascendant)",
          "texte": "Lors de l'alésage ascendant, il est interdit à toute personne de circuler à moins de 5 mètres du mât pendant le forage. La commande de forage doit être positionnée à 5 mètres du point de forage, à l'abri des projections de roche.",
          "sources": [
            "PRO-OP-ITH-007"
          ]
        },
        {
          "num": "3.4",
          "titre": "Distance de la commande à distance (forage à distance)",
          "texte": "Le travailleur doit installer le système de commande à distance à un minimum de 50 pieds (15 mètres) entre le foreur et le trou à forer. Le foreur et l'aide-foreur restent en tout temps dans la zone sécuritaire pendant le forage.",
          "sources": [
            "PRO-OP-ITH-012"
          ]
        },
        {
          "num": "3.5",
          "titre": "Distance barricade / premières pièces de matériel",
          "texte": "Le travailleur doit laisser une distance d'au moins 3 mètres (10 pieds) entre la barricade à l'entrée du chantier et les premières pièces de matériel (toolbox, huile, etc.).",
          "sources": [
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006",
        ...
        {
          "num": "3.6",
          "titre": "Distance foreuse / surcompresseur",
          "texte": "Le travailleur doit maintenir une distance de 7 mètres entre la foreuse et le surcompresseur.",
          "sources": [
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006",
        ...
        {
          "num": "3.7",
          "titre": "Interdiction de circuler devant la foreuse",
          "texte": "Pendant le forage du trou, il est interdit à toute personne de circuler en avant de la foreuse.",
          "sources": [
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006"
          ]
        ...
        {
          "num": "3.8",
          "titre": "Axe de déplacement de la tête V-30",
          "texte": "Le travailleur ne doit jamais se tenir dans l'axe de déplacement possible de la tête V-30 si elle se décroche. Il doit s'assurer que les contrôles sont en position neutre durant l'installation.",
          "sources": [
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-007"
          ]
        ...
        {
          "num": "3.9",
          "titre": "Distance lors de l'entretien V-30 et de la récupération de tige",
          "texte": "Lors de l'entretien de la V-30 ou de la récupération d'une tige, le travailleur (ou la manette de contrôle à distance) doit se tenir à 5 mètres de la ligne de forage et hors de la ligne de tir des chutes de la monterie.",
          "sources": [
            "PRO-OP-ITH-007"
          ]
        },
        {
          "num": "3.10",
          "titre": "Positionnement vers la sortie et hors de la ligne de sautage",
          "texte": "Le foreur et l'aide-foreur doivent se positionner vers la sortie en s'assurant que rien ne bloque l'accès, et ne jamais se tenir dans la ligne de sautage. Si le client l'exige, ils se placent derrière une protection (galerie perpendiculaire, équipement ou amas de roche).",
          "sources": [
            "PRO-OP-ITH-012"
          ]
        },
        {
          "num": "3.11",
          "titre": "Interdiction d'entrer dans la monterie",
          "texte": "Il est strictement interdit à tout employé, en tout temps, d'entrer dans la monterie de 30 pouces ou de descendre au fond de la monterie pour récupérer ou dégager des pièces métalliques, des outils, des taillants ou tout autre équipement. Seuls les équipements adaptés de M.R.I. doivent être utilisés.",
          "sources": [
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-008"
          ]
        ...
        {
          "num": "3.12",
          "titre": "Stabilité et positionnement des pièces démontées",
          "texte": "Le travailleur doit desserrer la sangle et placer la pompe de façon à être certain qu'elle ne se déplacera pas pour le frapper.",
          "sources": [
            "PRO-MEC-011"
          ]
        },
        {
          "num": "3.13",
          "titre": "Position stable lors des coups de masse",
          "texte": "Lorsqu'il faut frapper le manche de la clé avec une masse, le travailleur doit s'assurer que ses pieds reposent sur une surface solide et que personne ne se trouve dans l'axe (ligne de chute) advenant que la masse soit échappée.",
          "sources": [
            "PRO-OP-ITH-002",
            "PRO-OP-ITH-002A"
          ]
        ...
        {
          "num": "3.14",
          "titre": "Dégagement du gearbox pour l'installation de la clé",
          "texte": "Le travailleur doit placer le gearbox (réducteur) le plus loin possible des tables afin de disposer de l'espace nécessaire à l'installation de la clé.",
          "sources": [
            "PRO-OP-ITH-002",
            "PRO-OP-ITH-002A"
          ]
        ...
        {
          "num": "3.15",
          "titre": "Tubages ne dépassant pas du plancher",
          "texte": "Le travailleur ne doit pas laisser les tubages dépasser trop longs hors du plancher du chantier. Le trajet emprunté par les travailleurs doit rester exempt de tubages qui dépassent, la longueur de dépassement pouvant varier avec l'accumulation de boue de forage.",
          "sources": [
            "PRO-OP-ITH-014"
          ]
        },
        {
          "num": "3.16",
          "titre": "Validation du vissage avant exposition des mains",
          "texte": "Chaque fois qu'il doit exposer ses mains sous le marteau, le travailleur doit valider que le marteau est bien vissé au gear box. Il ne doit jamais exposer ses mains lors du dévissage manuel du marteau.",
          "sources": [
            "PRO-OP-ITH-016"
          ]
        },
        {
          "num": "3.17",
          "titre": "Position de l'opérateur lors de l'embarquement",
          "texte": "Lors de l'embarquement de la foreuse, l'opérateur doit toujours se placer à l'intérieur du panier et mettre la chaîne garde-corps.",
          "sources": [
            "PRO-OP-ITH-003"
          ]
        }
    ...
    {
      "id": "pieces-mouvement-mat",
      "titre": "Chapitre 4 — Pièces en mouvement, mât et têtes de forage",
      "intro": "Le mât, les boyaux hydrauliques, les têtes V-30 et les marteaux sont des sources de coincement et d'écrasement. Leur manipulation exige des séquences strictes et la protection des extrémités.",
      "articles": [
        {
          "num": "4.1",
          "titre": "Protection des mains et des doigts",
          "texte": "Le travailleur doit éviter de placer ses mains sous une pièce démontée et protéger ses doigts des coincements. Lors du retrait de la pompe, il doit la retenir avec les mains sur les boyaux, jamais en dessous.",
          "sources": [
            "PRO-MEC-011"
          ]
        },
        {
          "num": "4.2",
          "titre": "Décoincement des boyaux hydrauliques",
          "texte": "Lors du déplacement du mât en rotation, le travailleur doit surveiller les boyaux hydrauliques susceptibles de se coincer. Pour les décoincer, il revient en arrière et bouge le mât, et adopte une position stable si un effort est nécessaire.",
          "sources": [
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006",
        ...
        {
          "num": "4.3",
          "titre": "Défoncement sans rotation",
          "texte": "Lors du défoncement de trous, le travailleur doit pousser SANS ROTATION une tige de plus que la longueur du défoncement.",
          "sources": [
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006"
        ...
        {
          "num": "4.4",
          "titre": "Mât en position de transport",
          "texte": "Le travailleur doit placer le mât en position de transport (tête de forage à l'opposé des tables) et l'attacher à la foreuse avec un tire-fort ou un palan à chaîne avant de déplacer l'équipement.",
          "sources": [
            "PRO-OP-ITH-003"
          ]
        },
        {
          "num": "4.5",
          "titre": "Mât à l'horizontale pour la clé à saver sub",
          "texte": "Avant de travailler sur une tige ou un marteau coincé dans le saver sub, le travailleur doit mettre la flèche (boom) ou le mât en position horizontale afin d'éviter que la clé à saver sub ne tombe.",
          "sources": [
            "PRO-OP-ITH-002",
            "PRO-OP-ITH-002A"
          ]
        ...
        {
          "num": "4.6",
          "titre": "Corps sous les tables interdit",
          "texte": "Il est interdit de positionner toute partie de son corps sous les tables si le marteau n'est pas monté au-delà des tables et que la slip-plate n'est pas fermée. Lors d'un changement de bit, la bit doit être remontée au-delà des tables.",
          "sources": [
            "PRO-OP-ITH-014"
          ]
        },
        {
          "num": "4.7",
          "titre": "Vigilance au-dessus d'un couvercle de métal",
          "texte": "Lors du déplacement de la foreuse au-dessus d'un couvercle de métal situé sur la monterie, le travailleur doit demeurer attentif pour éviter que le couvercle ne se coince entre les tractions de la foreuse.",
          "sources": [
            "PRO-OP-ITH-004"
          ]
        },
        {
          "num": "4.8",
          "titre": "Accès libres entre contrôles, mât et support à tige",
          "texte": "Le travailleur doit garder libres en tout temps les accès séparant les contrôles, le mât et le support à tige : ni boyaux, ni casing, ni roche ne doivent les obstruer.",
          "sources": [
            "PRO-OP-ITH-007"
          ]
        },
        {
          "num": "4.9",
          "titre": "Driver sub et transport des marteaux",
          "texte": "Le travailleur doit installer le « DRIVER SUB » sur les marteaux en tout temps lors de leur manipulation. Le marteau doit être vissé au saver sub au complet sans être serré avec force.",
          "sources": [
            "PRO-OP-ITH-016",
            "PRO-OP-ITH-014"
          ]
        ...
        {
          "num": "4.10",
          "titre": "Retrait des tiges avant récupération d'un taillant brisé",
          "texte": "Avant d'entreprendre la récupération d'un taillant brisé, le travailleur doit sortir la V-30 de la monterie en enlevant les tiges de forage.",
          "sources": [
            "PRO-OP-ITH-008"
          ]
        },
        {
          "num": "4.11",
          "titre": "Remise en place des protections",
          "texte": "À la fin d'un changement de coupling, le travailleur doit remettre le couvercle de plastique afin de rétablir la protection, cette mesure découlant d'un début d'incendie causé par la surchauffe du bell housing et du couvercle.",
          "sources": [
            "PRO-MEC-011"
          ]
        }
    ...
    {
      "id": "protection-chutes-explosifs",
      "titre": "Chapitre 5 — Protection contre les chutes, terrain et explosifs",
      "intro": "Le forage en monterie expose à des risques de chute et de présence d'explosifs non détonnés. Les protections collectives (couvercle, cage, pilier de couronne) et individuelles (harnais) sont obligatoires.",
      "articles": [
        {
          "num": "5.1",
          "titre": "Couvert obligatoire sur la monterie",
          "texte": "Lors du forage de V-30 en descendant, le travailleur doit installer en tout temps le couvert (fourni par M.R.I. ou le client) sur la monterie. Le couvercle d'acier doit être installé dès la fin du forage, lors d'une suspension pour trous de production ou pour effectuer du déblocage, et laissé en place jusqu'à son retrait par l'équipe de dynamitage de la mine.",
          "sources": [
            "PRO-OP-ITH-005"
          ]
        },
        {
          "num": "5.2",
          "titre": "Protection antichute lors du retrait du couvert",
          "texte": "Lorsque le couvert est enlevé ou remis et que les travailleurs s'exposent à une chute, le travailleur près de la monterie doit être attaché en tout temps au moyen d'une longe restrictive ajustable empêchant l'accès au trou, ou d'un harnais antichute avec bloc rétractable, attaché à des points d'ancrage approuvés par le client. Il demeure attaché tant que le couvercle est retiré.",
          "sources": [
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-008"
          ]
        ...
        {
          "num": "5.3",
          "titre": "Protection du trou ouvert",
          "texte": "Le travailleur doit protéger les travailleurs contre le trou en laissant un pilier de couronne en place ou en installant une plaque d'acier identifiée sur le trou.",
          "sources": [
            "PRO-OP-ITH-006"
          ]
        },
        {
          "num": "5.4",
          "titre": "Inspection des explosifs avant déplacement",
          "texte": "Avant de déplacer l'unité à la première ligne de forage, le travailleur doit laver la zone à partir des headers, vérifier l'écaillage et inspecter le chantier à la recherche d'explosifs restants ou non détonnés.",
          "sources": [
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006",
        ...
        {
          "num": "5.5",
          "titre": "Écaillage, purge et cage de protection",
          "texte": "Le travailleur doit interrompre les travaux au besoin pour écailler ou purger, puis sécuriser la cage de protection. Il installe la cage à grillage à mailles soudées pour canaliser les débris loin de l'opérateur et nettoie les déflecteurs et grillages avant de s'exposer en dessous.",
          "sources": [
            "PRO-OP-ITH-007"
          ]
        },
        {
          "num": "5.6",
          "titre": "Surveillance des explosifs au déblocage",
          "texte": "Lors du déblocage, le travailleur doit surveiller le matériel qui sort du trou. En présence d'explosif, il arrête l'opération avec la foreuse et avise le superviseur. Lors du déblocage d'un trou dynamité à l'ANFO (amex), il met de l'eau dans les tiges de forage pour diminuer le risque d'explosion.",
          "sources": [
            "PRO-OP-ITH-012"
          ]
        },
        {
          "num": "5.7",
          "titre": "Tubage de protection du collet",
          "texte": "Le travailleur doit installer le tubage au collet des trous pour protéger le collet contre la chute de roches susceptible de bloquer le trou et de nuire au forage ou au chargement d'explosifs.",
          "sources": [
            "PRO-OP-ITH-014"
          ]
        },
        {
          "num": "5.8",
          "titre": "Hauteur plancher-toit",
          "texte": "Le travailleur doit maintenir une hauteur plancher-toit comprise entre 12 et 14 pieds (maximum 4,3 m). Au-delà de 4,3 m (14 pi), il relève le plancher avec de la roche abattue.",
          "sources": [
            "PRO-OP-ITH-007"
          ]
        }
    ...
    },
    {
      ...
      "titre": "Chapitre 6 — Manutention, levage et accessoires de gréage",
      "intro": "La manipulation de charges lourdes (centralisateurs, marteaux, pompes) et le levage exigent des accessoires certifiés, inspectés et non modifiés, ainsi que des techniques sûres et, au besoin, un second travailleur.",
      "articles": [
        {
          "num": "6.1",
          "titre": "Inspection des accessoires de levage",
          "texte": "Le travailleur doit inspecter tous les accessoires de levage avant leur utilisation et remplacer obligatoirement tout accessoire présentant une anomalie avant d'entreprendre le déplacement. Seules des composantes approuvées sont autorisées ; aucune modification n'est permise.",
          "sources": [
            "PRO-OP-ITH-003"
          ]
        },
        {
          "num": "6.2",
          "titre": "Crochets munis de linguets",
          "texte": "Le travailleur ne doit utiliser que des tire-forts ou palans à levier (come along) dont les crochets sont munis de linguets de sécurité.",
          "sources": [
            "PRO-OP-ITH-002",
            "PRO-OP-ITH-002A"
          ]
        ...
        {
          "num": "6.3",
          "titre": "Charge certifiée de l'ancrage du mât",
          "texte": "Le travailleur ne doit jamais dépasser la charge certifiée de l'ancrage du mât (2500 kg) lors de la mise en tension avec le tire-fort, et ne doit utiliser qu'un ancrage certifié pour cette charge.",
          "sources": [
            "PRO-OP-ITH-002",
            "PRO-OP-ITH-002A"
          ]
        ...
        {
          "num": "6.4",
          "titre": "Installation du centralisateur à deux travailleurs",
          "texte": "Le travailleur doit toujours réaliser l'installation du centralisateur à deux travailleurs. Chaque pièce pesant 46 livres (poids total du centralisateur : 93,0 lbs), il doit se positionner de la meilleure manière avant de la manipuler.",
          "sources": [
            "PRO-MEC-011"
          ]
        },
        {
          "num": "6.5",
          "titre": "Retenue de la pompe lors du retrait",
          "texte": "Lors du retrait de la pompe, qui n'est plus retenue que par les boyaux hydrauliques et la sangle, le travailleur doit la retenir avec les mains sur les boyaux.",
          "sources": [
            "PRO-MEC-011"
          ]
        },
        {
          "num": "6.6",
          "titre": "Transport des marteaux au chariot",
          "texte": "Le travailleur doit transporter en tout temps les marteaux de 6 pouces (211 lbs) à l'aide du chariot conçu à cet effet et s'assurer que le chariot est stable avant d'y déposer le marteau. Les marteaux de 3 pouces (60 lbs) et 4 pouces (89 lbs) sont installés manuellement sur le gear box de la même manière que les tiges de forage. Pour les trous de plus de 6½ po, le chariot de transport ou la cloche et la chaîne sont utilisés.",
          "sources": [
            "PRO-OP-ITH-016",
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-006",
        ...
        {
          "num": "6.7",
          "titre": "Chaînes de retenue du marteau",
          "texte": "Le travailleur ne doit retirer la chaîne de sûreté du chariot qu'après avoir vissé et accoté le marteau dans le saver sub. Il doit attacher le marteau à l'aide de la chaîne de retenue avant de sortir le chariot.",
          "sources": [
            "PRO-OP-ITH-016"
          ]
        },
        {
          "num": "6.8",
          "titre": "Second travailleur pour les trous profonds",
          "texte": "Le travailleur doit privilégier la présence d'un second travailleur (aide-foreur) pour le forage et l'arrachement des tiges des trous de 200 pieds et plus. À défaut, le foreur doit prévoir des pauses.",
          "sources": [
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006",
        ...
        {
          "num": "6.9",
          "titre": "Chaîne de levage de la tête V-30",
          "texte": "Le travailleur doit utiliser une chaîne de grade 80 (capacité 7100 lbs), de 12 pieds entre le gear box de la foreuse et le drive shaft de la V-30, pour suspendre, hisser et positionner la tête V-30.",
          "sources": [
            "PRO-OP-ITH-006",
            "PRO-OP-ITH-007"
          ]
        ...
        {
          "num": "6.10",
          "titre": "Ancrage des palans à chaîne",
          "texte": "Avec la méthode des palans à chaîne, le travailleur doit être très vigilant selon l'équipement et la proximité des employés, et ancrer les palans à des boulons à œil conformes ou à un anneau conforme scellé à la résine.",
          "sources": [
            "PRO-OP-ITH-006"
          ]
        },
        {
          "num": "6.11",
          "titre": "Gréage du traîneau et de la remorque",
          "texte": "Le travailleur doit relier le traîneau ou la remorque au véhicule avec deux élingues d'au moins 1 po × 8 pieds, fixées avec des manilles de 1¼ po minimum. Il privilégie l'utilisation de la main dans le godet d'une chargeuse plutôt que d'attacher directement la remorque à l'arrière d'un véhicule, et positionne la remorque à angle pour éviter un contrecoup au chargement.",
          "sources": [
            "PRO-OP-ITH-003"
          ]
        },
        {
          "num": "6.12",
          "titre": "Stabilité du compresseur à l'accouplement",
          "texte": "Le travailleur doit s'assurer de la stabilité du compresseur lors de l'accouplement et du désaccouplement, en appliquant au besoin des stabilisateurs ou des cales de roues. Il relie l'attache du compresseur au véhicule avec des manilles de 1¼ po minimum et fixe les deux chaînes de sécurité au véhicule de remorquage.",
          "sources": [
            "PRO-OP-ITH-003"
          ]
        },
        {
          "num": "6.13",
          "titre": "Déplacement sans remorque",
          "texte": "Le travailleur ne doit déplacer la foreuse sans remorque qu'à plat, sur de courtes distances et à basse vitesse ; il est interdit de la déplacer sans remorque dans la rampe. Il installe alors la barre de tir avec des manilles 3/4 po, la raccorde à la chargeuse-navette avec une manille de 1¼ po et installe une chaîne de sécurité reliant la foreuse à la chargeuse.",
          "sources": [
            "PRO-OP-ITH-003"
          ]
        }
    ...
    {
      "id": "outils-cles",
      "titre": "Chapitre 7 — Outils, clés et serrage",
      "intro": "L'emploi des bons outils, de manière conforme, protège l'intégrité des pièces et la sécurité des travailleurs. Certains outils sont expressément interdits pour des opérations précises.",
      "articles": [
        {
          "num": "7.1",
          "titre": "Interdiction du wescot et du pipe wrench",
          "texte": "Il est interdit d'utiliser un wescot ou un pipe wrench pour le serrage des boulons du centralisateur. Le serrage se fait à l'aide de l'outil adéquat (clé ou box) en maintenant une tension sur les lockwashers.",
          "sources": [
            "PRO-MEC-011"
          ]
        },
        {
          "num": "7.2",
          "titre": "Préservation des filets",
          "texte": "Le travailleur ne doit pas endommager les filets des boulons lors de leur insertion dans les trous prévus à cet effet.",
          "sources": [
            "PRO-MEC-011"
          ]
        },
        {
          "num": "7.3",
          "titre": "Masse de caoutchouc sur le bell housing",
          "texte": "Le bell housing étant en aluminium, le travailleur doit utiliser uniquement une masse de caoutchouc pour le décoller afin de ne pas l'endommager.",
          "sources": [
            "PRO-MEC-011"
          ]
        },
        {
          "num": "7.4",
          "titre": "Décollement d'une coupling collée",
          "texte": "Si la coupling est collée, le travailleur doit retirer le bell housing puis frapper sur la pry bar avec une masse ou un marteau, en prenant garde de ne pas endommager le shaft du moteur électrique.",
          "sources": [
            "PRO-MEC-011"
          ]
        },
        {
          "num": "7.5",
          "titre": "Manipulation des trépans et taillants",
          "texte": "Le travailleur doit manipuler les trépans avec attention, en évaluant les distances pour les déposer afin d'éviter les coincements.",
          "sources": [
            "PRO-OP-ITH-004"
          ]
        },
        {
          "num": "7.6",
          "titre": "Récupération au racloir de monterie",
          "texte": "Le travailleur doit récupérer le taillant ou les pièces brisées au fond de la monterie uniquement à l'aide du racloir de monterie (raise scraper) conçu à cet effet. Le couvercle est remis sur la monterie entre les manipulations du racloir.",
          "sources": [
            "PRO-OP-ITH-008"
          ]
        },
        {
          "num": "7.7",
          "titre": "Raccord de désaccouplement V-30",
          "texte": "Le travailleur doit utiliser obligatoirement le raccord situé entre la V-30 et la tige pour empêcher le serrage et permettre un désaccouplement facile.",
          "sources": [
            "PRO-OP-ITH-006"
          ]
        },
        {
          "num": "7.8",
          "titre": "Absence de pièces libres avant transport",
          "texte": "Le travailleur doit s'assurer qu'aucune pièce libre ni aucun outil ne se trouve sur la foreuse avant de commencer le transport.",
          "sources": [
            "PRO-OP-ITH-003"
          ]
        }
    ...
    },
    {
      ...
      "titre": "Chapitre 8 — Inspection, vérification et remise en état",
      "intro": "Une inspection rigoureuse des équipements, fluides et assemblages avant et après opération est primordiale. Aucune opération ne débute sur un équipement non vérifié.",
      "articles": [
        {
          "num": "8.1",
          "titre": "Inspection visuelle avant opération",
          "texte": "Le travailleur doit effectuer une inspection visuelle de l'équipement de forage, de la ventilation, de l'alimentation d'énergie et de la distribution d'eau et d'air avant toute opération, ainsi que des huiles, jauges et fuites avant de déplacer l'unité de forage.",
          "sources": [
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-007"
          ]
        ...
        {
          "num": "8.2",
          "titre": "Inspection des outils avant la tâche",
          "texte": "Le responsable du forage doit inspecter les outils nécessaires et coordonner la tâche avant de débuter.",
          "sources": [
            "PRO-OP-ITH-002",
            "PRO-OP-ITH-002A"
          ]
        ...
        {
          "num": "8.3",
          "titre": "Vérification de la quincaillerie du centralisateur",
          "texte": "Avant le serrage, le travailleur doit vérifier la présence des 12 boulons (1/2 × 1 po 3/8 de long), 12 locknuts 1/2 et 12 lockwashers 1/2, répartis à raison de 6 dans un sens et 6 dans l'autre.",
          "sources": [
            "PRO-MEC-011"
          ]
        },
        {
          "num": "8.4",
          "titre": "Nettoyage et antiseize au remontage",
          "texte": "Avant le remontage de la coupling, le travailleur doit bien nettoyer le shaft et l'épaulement de la pompe ainsi que le shaft du moteur électrique, puis appliquer de l'antiseize. Il s'assure que la coupling est « FLUSH » au shaft avant de serrer au maximum la barrure.",
          "sources": [
            "PRO-MEC-011"
          ]
        },
        {
          "num": "8.5",
          "titre": "Vérification de l'alignement par insertion manuelle",
          "texte": "Le travailleur doit insérer à la main les 2 boulons de la pompe pour vérifier le bon alignement avant de les serrer avec la clé.",
          "sources": [
            "PRO-MEC-011"
          ]
        },
        {
          "num": "8.6",
          "titre": "Protection du fil de détection à feu",
          "texte": "Lors de la pose de la sangle à cliquet autour de la pompe et du cadre, le travailleur ne doit pas coincer le fil de détection du système à feu.",
          "sources": [
            "PRO-MEC-011"
          ]
        },
        {
          "num": "8.7",
          "titre": "Suivi après bris de tige",
          "texte": "Après un bris de tige, le travailleur doit retirer et vérifier toutes les autres tiges, étiqueter et retourner la tige brisée au fournisseur, et remplir un rapport d'incident.",
          "sources": [
            "PRO-OP-ITH-007"
          ]
        },
        {
          "num": "8.8",
          "titre": "Signature de la procédure sur les barricades",
          "texte": "Le travailleur doit placer la procédure dans un sac étanche sur les clôtures de tous les accès et la faire signer par le foreur ayant visité ces endroits avant le début du forage, au début de chaque quart de travail.",
          "sources": [
            "PRO-OP-ITH-012"
          ]
        },
        {
          "num": "8.9",
          "titre": "Alignement préalable au tubage",
          "texte": "Avant l'installation d'un tubage, le travailleur doit respecter au préalable la procédure de forage PRO-OP-ITH-004 et s'assurer que la foreuse est bien alignée selon les plans de forage.",
          "sources": [
            "PRO-OP-ITH-014"
          ]
        },
        {
          "num": "8.10",
          "titre": "Vérification de la main d'attelage",
          "texte": "Le travailleur doit vérifier le bon fonctionnement de la main d'attelage située dans le godet du scoop.",
          "sources": [
            "PRO-OP-ITH-003"
          ]
        }
    ...
    {
      "id": "communication-signalisation",
      "titre": "Chapitre 9 — Communication, signalisation et barricades",
      "intro": "La signalisation des zones de danger, le barricadage des accès et la communication entre intervenants préviennent l'exposition de tiers et coordonnent les interventions critiques.",
      "articles": [
        {
          "num": "9.1",
          "titre": "Barricades et affiches d'avertissement",
          "texte": "Le travailleur doit installer des barricades ou des affiches pour aviser les travailleurs des opérations en cours (trous ouverts, forage, etc.). Lorsque les équipements sont sortis du chantier, il installe une barricade et/ou des affiches pour aviser de la condition de trou ouvert.",
          "sources": [
            "PRO-OP-ITH-004",
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006",
        ...
        {
          "num": "9.2",
          "titre": "Signalisation des accès en forage à distance",
          "texte": "Le travailleur doit barricader tous les accès aux lieux de forage par une clôture (selon les exigences du client) ou les faire garder par un travailleur, et apposer une signalisation indiquant le type de travaux (ACCÈS INTERDIT, FORAGE EN COURS, FORAGE À DISTANCE).",
          "sources": [
            "PRO-OP-ITH-012"
          ]
        },
        {
          "num": "9.3",
          "titre": "Barricadage en cas de bris de tige",
          "texte": "En cas de bris de tige, le travailleur doit installer une barricade, un ruban rouge et/ou des panneaux ACCÈS INTERDIT à l'entrée du chantier pour empêcher tout accès.",
          "sources": [
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006"
          ]
        ...
        {
          "num": "9.4",
          "titre": "Avis au contremaître lors d'un bris de tige",
          "texte": "En cas de bris de tige, le travailleur doit aviser le contremaître (superviseur) et n'effectuer aucun travail de forage avant son arrivée. La présence du contremaître est requise jusqu'à la fin de la récupération de la tige. Une analyse de risque doit être effectuée avant d'opérer la foreuse à distance pour récupérer une tige brisée.",
          "sources": [
            "PRO-OP-ITH-005",
            "PRO-OP-ITH-006",
            "PRO-OP-ITH-007"
        ...
        {
          "num": "9.5",
          "titre": "Avis au superviseur pour taillant brisé non récupérable",
          "texte": "Le travailleur doit avertir le superviseur de la mine lorsqu'un taillant brisé demeure présent et que l'accès au niveau inférieur n'est pas possible pour le récupérer.",
          "sources": [
            "PRO-OP-ITH-008"
          ]
        },
        {
          "num": "9.6",
          "titre": "Communication avec l'opérateur et lors du raccordement",
          "texte": "Le travailleur doit maintenir une bonne communication entre le foreur et l'aide-foreur durant toute manipulation, avec l'opérateur de la chargeuse durant un déplacement sans remorque, et disposer d'un moyen de communication fonctionnel (radio ou système femco) aux niveaux supérieur et inférieur lors du raccordement de la tête. Pour toute visite des lieux de forage à distance, l'opérateur est contacté par radio.",
          "sources": [
            "PRO-OP-ITH-016",
            "PRO-OP-ITH-003",
            "PRO-OP-ITH-006",
        ...
        {
          "num": "9.7",
          "titre": "Signalisation du traîneau au sol",
          "texte": "Le travailleur ne doit jamais attacher le traîneau au mur après le déplacement ; il le laisse par terre et le signale avec un ruban jaune.",
          "sources": [
            "PRO-OP-ITH-003"
          ]
        },
        {
          "num": "9.8",
          "titre": "Politique d'escorte des équipements",
          "texte": "Le travailleur doit appliquer la politique du site concernant les escortes pour le déplacement des équipements.",
          "sources": [
            "PRO-OP-ITH-003"
          ]
        }
    ...
    {
      "id": "epi-eau-ventilation",
      "titre": "Chapitre 10 — Équipements de protection individuelle, eau et ventilation",
      "intro": "Au-delà des protections collectives, le port des EPI requis et la gestion de l'eau et de la ventilation protègent le travailleur des projections, des poussières et des déblais de forage.",
      "articles": [
        {
          "num": "10.1",
          "titre": "EPI lors de l'affûtage des forets",
          "texte": "Le travailleur doit porter tout l'équipement de protection individuelle (EPI) requis lors de l'affûtage et du façonnement des forets.",
          "sources": [
            "PRO-OP-ITH-006"
          ]
        },
        {
          "num": "10.2",
          "titre": "Masque lors du soufflage des déblais",
          "texte": "Le travailleur doit porter un masque lors du soufflage des déblais de forage et ne jamais s'exposer directement sous le trou de la V-30.",
          "sources": [
            "PRO-OP-ITH-007"
          ]
        },
        {
          "num": "10.3",
          "titre": "Harnais avant retrait du couvercle de monterie",
          "texte": "Le travailleur doit porter un harnais et s'attacher à un ancrage ou à une ligne de vie avant d'enlever le couvercle de la monterie, et le porter chaque fois que le couvert protecteur doit être enlevé et qu'il s'expose à une chute, attaché à des points d'ancrage approuvés par le client.",
          "sources": [
            "PRO-OP-ITH-008",
            "PRO-OP-ITH-005"
          ]
        ...
        {
          "num": "10.4",
          "titre": "Retrait des roches à l'eau",
          "texte": "Le travailleur doit privilégier l'utilisation de l'eau pour retirer une roche des tables. Si l'eau est insuffisante, il retire la V-30 et éloigne la foreuse avant d'enlever la roche manuellement.",
          "sources": [
            "PRO-OP-ITH-007"
          ]
        }
